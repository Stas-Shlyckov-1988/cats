                ...
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="name" value="{{ $cat->name }}" class="form-control" id="inputGroupName" required>
                        </div>

                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupEmail">Email</label>
                            <input type="email" name="email" value="{{ $cat->email }}" class="form-control" id="inputGroupEmail" required>
                        </div>
